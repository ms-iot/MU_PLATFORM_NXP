...
!endif
  ...
  FLASH_DEFINITION               = ARM/VExpressPkg/ArmVExpress-CTA15-A7.fdf
...
[LibraryClasses.common]
  ...
  ArmPlatformLib|ARM/VExpressPkg/Library/ArmVExpressLibCTA15-A7/ArmVExpressLib.inf

  ArmPlatformSysConfigLib|ARM/VExpressPkg/Library/ArmVExpressSysConfigLib/ArmVExpressSysConfigLib.inf

  #DebugAgentTimerLib|ARM/VExpressPkg/Library/DebugAgentTimerLib/DebugAgentTimerLib.inf

  # ARM General Interrupt Driver in Secure and Non-secure
  ArmGicLib|ArmPkg/Drivers/ArmGic/ArmGicLib.inf

  LcdHwLib|ArmPlatformPkg/Library/HdLcd/HdLcd.inf
  LcdPlatformLib|ARM/VExpressPkg/Library/HdLcdArmVExpressLib/HdLcdArmVExpressLib.inf

  ArmSmcLib|ArmPkg/Library/ArmSmcLib/ArmSmcLib.inf

[LibraryClasses.common.DXE_RUNTIME_DRIVER]
  ArmPlatformSysConfigLib|ARM/VExpressPkg/Library/ArmVExpressSysConfigRuntimeLib/ArmVExpressSysConfigRuntimeLib.inf
...
[LibraryClasses.ARM]
  ...
  #
  ResetSystemLib|ARM/VExpressPkg/Library/ResetSystemLib/ResetSystemLib.inf
...
!endif
  ...
  RVCT:*_*_ARM_PLATFORM_FLAGS == --cpu Cortex-A15 -I$(WORKSPACE)/ARM/VExpressPkg/Include/CTA15-A7

  GCC:*_*_ARM_PLATFORM_FLAGS == -mcpu=cortex-a15 -I$(WORKSPACE)/ARM/VExpressPkg/Include/CTA15-A7

  XCODE:*_*_ARM_PLATFORM_FLAGS = -I$(WORKSPACE)/ARM/VExpressPkg/Include/CTA15-A7
...
[Components.common]
  ...
  # Platform
  #
  ARM/VExpressPkg/Drivers/ArmVExpressDxe/ArmHwDxe.inf
...
!endif
  ...
  # FDT installation
  #
  ARM/Drivers/FdtPlatformDxe/FdtPlatformDxe.inf {
    <LibraryClasses>
      BdsLib|ARM/Library/BdsLib/BdsLib.inf
  }
